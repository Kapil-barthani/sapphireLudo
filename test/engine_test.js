...
// Test 10: Must capture opponent token before entering home runway
...
assert(lapMove.newStep === 2, 'Token wrapped around common track to step 2 because no capture made');
